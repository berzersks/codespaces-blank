...
class CoroutineObject implements \ArrayAccess, \Serializable, \Countable, \Iterator
{
    /**
     * @var array
     */
    ...
    /**
     * @return CoroutineObject|StringObject
     */
    ...
    public function append(...$values): CoroutineObject
    {
    ...
    /**
     * @return CoroutineObject|mixed|StringObject
     */
